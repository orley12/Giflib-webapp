...
public class CategoryController {
    ...
    public String updateCategory(@Valid Category category, BindingResult result, RedirectAttributes redirectAttributes) {
        ...
        if (result.hasErrors()){
            ...
            return String.format("redirect:/%s/edit", category.getId());
        }
...
//            redirectAttributes.addFlashAttribute("flash", new FlashMessage("Categories as to be empty", FlashMessage.Status.FAILURE));
...
//        }
        ...
        redirectAttributes.addFlashAttribute("flash", new FlashMessage("Category was successfully deleted", FlashMessage.Status.SUCCESS));
        // TODO: Redirect browser to /categories
