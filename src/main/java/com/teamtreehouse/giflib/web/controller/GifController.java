...
public class GifController {
    ...
    public String updateGif(Gif gif, MultipartFile file, RedirectAttributes redirectAttributes) {
    ...
    public String deleteGif(@PathVariable Long gifId, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("flash",
                new FlashMessage("Gif was sucessfully deleted", FlashMessage.Status.SUCCESS));
